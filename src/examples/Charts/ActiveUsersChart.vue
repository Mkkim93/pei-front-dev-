...
<template>
  <div class="card">
    <div class="card-body p-3">
      ...
      <h6 class="mt-4 mb-0 me-2">간편 차트1</h6>
      <p class="text-sm me-2">
        (
        <span class="font-weight-bolder">+23%</span>) 진료과별 내역
      </p>
        ...
        <div class="row">
          <div class="py-3 col-3 ps-0">
            <div class="mb-2 d-flex">
              ...
              <p class="mt-1 mb-0 px-1 text-xs font-weight-bold">진료과</p>
            </div>
          ...
          <div class="py-3 col-3 ps-0">
            <div class="mb-2 d-flex">
              ...
              <p class="mt-1 mb-0 px-1 text-xs font-weight-bold">의사</p>
            </div>
          ...
          <div class="py-3 col-3 ps-0">
            <div class="mb-2 d-flex">
              ...
              <p class="mt-1 mb-0 px-1 text-xs font-weight-bold">병동</p>
            </div>
          ...
          <div class="py-3 col-3 ps-0">
            <div class="mb-2 d-flex">
              ...
              <p class="mt-1 mb-0 text-xs px-1 font-weight-bold">조사그룹</p>
            </div>
