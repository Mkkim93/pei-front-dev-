  ...
  <div class="fixed-plugin">
    ...
    <div class="shadow-lg card">
      ...
      <div class="pt-0 card-body pt-sm-3">
        ...
        <!-- Sidenav Type -->
        <div class="mt-3">
          <h6 class="mb-0">사이드바 메뉴</h6>
          <p class="text-sm">White / Dark 중 선택해주세요.</p>
        </div>
