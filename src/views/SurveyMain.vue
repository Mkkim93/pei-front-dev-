...
import { adminChecked } from '@/utils/auth'; 
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#!" @click.prevent="goAbout">About</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#!" @click.prevent="goAdmin">관리자</a>
            </li>
          </ul>
        </ul>
      </div>
  ...
  <section class="pt-4">
    <div class="container px-lg-5">
      <div class="row gx-lg-5">
        ...
        <div class="col-lg-8">
          <div class="row">
            <div class="col-md-6 col-xxl-6 mb-4" v-for="hospital in hospitalListData" :key="hospital.id">
